...
class Terp_Table(Base):
    ...
    terp_flower_id = Column(BigInteger, primary_key=True, nullable=False, default=0.0)
    terp_concentrate_id = Column(BigInteger, primary_key=True, nullable=False, default=0.0)
    terp_pre_roll_id = Column(BigInteger, primary_key=True, nullable=False, default=0.0)
    terp_edible_id = Column(BigInteger, primary_key=True, nullable=False, default=0.0)
