...
api_router.include_router(
    route_concentrate_rankings.router, prefix="/concentrate_ranking", tags=["concentrate_ranking"]
)
api_router.include_router(route_mystery_voters.router, prefix="/mystery_voters", tags=["mystery_voters"])
api_router.include_router(route_edible_rankings.router, prefix="/edible_rankings", tags=["edible_rankings"])
